...
class About extends Component {
  render() {
    let partyAnimalStyle = {
      "backgroundImage": "linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(http://s.newsweek.com/sites/www.newsweek.com/files/styles/embed-lg/public/2017/05/26/kim-jong-un-celebrates.jpg)",
    ...
    let popularStyle = {
      "backgroundImage": "linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(https://static.independent.co.uk/s3fs-public/thumbnails/image/2013/07/17/11/v3-kim1.jpg)",
      "backgroundSize": "cover",
      "textShadow": "1px 1px 2px black",
    ...
    return (
      ...
      <section className="row" style= {partyAnimalStyle}>
